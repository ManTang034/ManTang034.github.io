...
//     $('.copyright').html('©2023 <i class="fa-fw fas fa-heartbeat card-announcement-animation cc_pointer"></i> By ManTang');
// })
$(document).ready(function(e){
    $('.copyright').html('©2023 <i class="fa-solid fa-shield-halved fa-flip"></i> By ManTang');
})
...
BirthDay=new Date("7/11/2023 0:0:0");
today=new Date();
